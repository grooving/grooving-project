...
class PortfolioTestCase(TestCase):
    ...
    def test_show_portfolio(self):
        ...
        artist1.portfolio = id
        artist1.save()

        response = self.client.get('/portfolio/' + id, format='json')
